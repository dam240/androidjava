...
<html>
  ...
  <body>
    ...
    <table align="center" border="1" cellpadding="0" cellspacing="0">
    	...
    	<tr class="trOneLevel">
    		<td width="200px;"><a href="list2.action?pid=<s:property value="#cs.A_id"/>"><s:property value="#cs.book_name"/></a></td>
    		<td><s:property value="#cs.book_log"/></td>
    		<td width="200px;">
    		  <a href="up.action?pid=<s:property value="#cs.A_id"/>">修改</a>
    		  <a onclick="return confirm('您是否真要删除该一级分类？')" href="delete1.action?pid=<s:property value="#cs.A_id"/>">删除</a>
    		</td>
    	</tr>
      </s:iterator>
