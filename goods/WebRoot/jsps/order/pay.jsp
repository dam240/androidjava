...
<div class="divContent">
	<span class="spanPrice">支付金额：</span><span class="price_t">&yen;${ioc.jin}</span>
	<span class="spanOid">编号：${ioc.order_id}</span>
</div>
...
<div class="divBank">
	...
	<div style="margin: 40px;">
		<a href="zhi_fu.action?commit=${ioc.order_id}" class="linkNext">下一步</a>
	</div>
</div>
</form>
  </body>
