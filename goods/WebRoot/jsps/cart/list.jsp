	...
	$(".jian").click(function() {
		...
		if(quantity == 1) {
			if(confirm("您是否真要删除该条目？")) {
		          ...
		          location = "delete_car.action?pid=" + cartItemId;
				alert("删除成功！");		
			}
		} else {
...
function batchDelete() {
	...
	location = "delete_carLIST.action?bname="+cartItemIdArray;
}
...
<%
    ...
    String te =(String)request.getAttribute("bool");
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
	...
	<tr align="center">
		<td align="left">
			<input value="<s:property value="#cs.id" />" type="checkbox" name="checkboxBtn" checked="checked"/>
		</td>
		<td align="left" width="70px">
			<a class="linkImage" href="<c:url value='/jsps/book/desc.jsp'/>"><img border="0" width="54" align="top" src="<%=basePath%><s:property value="#cs.tu_B" />  "/></a>
		</td>
		<td align="left" width="400px">
		    <a href="<c:url value='/jsps/book/desc.jsp'/>"><span><s:property value="#cs.book_name" /> </span></a>
		</td>
		<td><span>&yen;<span class="currPrice" id="${cs.id}CurrPrice"><s:property value="#cs.dan_ji" /></span></span></td>
		<td>
			<a class="jian" id="${cs.id}Jian"></a><input class="quantity" readonly="readonly" id="${cs.id}Quantity" type="text" value="<s:property value="#cs.mout" />"/><a class="jia" id="${cs.id}Jia"></a>
		</td>
		<td width="100px">
			<span class="price_n">&yen;<span class="subTotal" id="${cs.id}Subtotal"><s:property value="#cs.xi_ji" /></span></span>
		</td>
		<td>
			<a href="delete_car.action?pid=<s:property value="#cs.id" />"> 删除</a>
		</td>
	</tr>
</s:iterator>
	...
	<form id="jieSuanForm" action="ok_bbs.action" method="post">
