...
<script type="text/javascript">
	function _go() {
		...
		location = "book_valuse.action?now="+pc;
	}
</script>
...
<div class="divBody">
  <div class="divContent">
    ...
    <!--     <span class="spanBtnDisabled">上一页</span> -->
        ...
        <a href="book_valuse.action?now=${requestScope.page.now -1 }" class="aBtn bold">上一页</a>
<% } %>
    ...
    <%-- 显示页码列表 --%>
           ...
           <%
            ...
            {
             %>
         <a href="book_valuse.action?now=<%=i %>"> <span class="aBtn bold" ><%=i %></span></a>
           <%
           }
           }
            %>
 ...
 -->        <a href="book_valuse.action?now=${requestScope.page.now + 1 }" class="aBtn bold">下一页</a> 
             <%} %>
