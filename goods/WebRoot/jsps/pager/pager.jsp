...
<div class="divBody">
  <div class="divContent">
    ...
    <!--     <span class="spanBtnDisabled">上一页</span> -->
        ...
        <a href="bean.action?now=${requestScope.page.now -1 }" class="aBtn bold">上一页</a>
<% } %>
    ...
    <%-- 显示页码列表 --%>
           ...
           <%
            ...
            {
             %>
         <a href="bean.action?now=<%=i %>"> <span class="aBtn bold" ><%=i %></span></a>
           <%
           }
           }
            %>
 ...
 -->        <a href="bean.action?now=${requestScope.page.now + 1 }" class="aBtn bold">下一页</a> 
             <%} %>
