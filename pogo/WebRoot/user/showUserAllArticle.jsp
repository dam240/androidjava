									...
									<s:iterator value="#request.all" id="art">
										<tr>
											<td bgcolor="#FFFFFF">
												...
												<a href=show?id=<s:property value='#art.id'/>><s:property value="#art.title"/></a>
													...
													<div align='right' class='smalltxt' height='32px'>
														...
														<!-- 评论与点击数 -->
														|评论()|点击(<s:property value="#art.hiate" />)
													</div> </font>
											</td>
										</tr>
									</s:iterator>
										<tr>
											<td align="center">
												<s:if test="#request.page.hasPrePage">
													<a href="addArticle2?curr=1">首页</a>
													<a href="addArticle2?curr=${page.currentPage -1 }">上一页</a>
												</s:if>
												<s:else>
													首页
													上一页
												...
												<s:if test="#request.page.hasNextPage">
													<a href="addArticle2?curr=${page.currentPage + 1 }">下一页</a>
													<a href="addArticle2?curr=${page.totalPage }">尾页</a>			
												</s:if>
												<s:else>
													下一页
													尾页
